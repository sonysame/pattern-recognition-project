...
#_2gram_api_df.info()
_2gram_api_sorted_df=_2gram_api_df.sort_values(by=['2gram_binary_malware_TF-IDF3'], ascending=False)
...
#_3gram_api_df.info()
_3gram_api_sorted_df=_3gram_api_df.sort_values(by=['3gram_binary_malware_TF-IDF3'], ascending=False)
...
#_4gram_api_df.info()
_4gram_api_sorted_df=_4gram_api_df.sort_values(by=['4gram_binary_malware_TF-IDF3'], ascending=False)
