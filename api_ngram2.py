...
def main():
    ...
    _2_binary_malware_tf_idf1 = np.round(np.multiply(_2malware_tf, _2_binary_malware_calc_idf), 4)
    _2_binary_malware_tf_idf2 = np.round(np.multiply(np.multiply(_2malware_tf, _2malware_df),_2_binary_malware_calc_idf), 4)
    _2_binary_malware_tf_idf3 = np.round(np.multiply(np.multiply(_2malware_tf, np.log2(_2malware_df+0.1)),_2_binary_malware_calc_idf), 4)
    _2_binary_malware_tf_idf4 = np.round(np.multiply(np.multiply(_2malware_tf, np.log10(_2malware_df+0.1)),_2_binary_malware_calc_idf), 4)
    ...
    _3_binary_malware_tf_idf1 = np.round(np.multiply(_3malware_tf, _3_binary_malware_calc_idf), 4)
    _3_binary_malware_tf_idf2 = np.round(np.multiply(np.multiply(_3malware_tf, _3malware_df),_3_binary_malware_calc_idf), 4)
    _3_binary_malware_tf_idf3 = np.round(np.multiply(np.multiply(_3malware_tf, np.log2(_3malware_df+0.1)),_3_binary_malware_calc_idf), 4)
    _3_binary_malware_tf_idf4 = np.round(np.multiply(np.multiply(_3malware_tf, np.log10(_3malware_df+0.1)),_3_binary_malware_calc_idf), 4)
    ...
    _4_binary_malware_tf_idf1 = np.round(np.multiply(_4malware_tf, _4_binary_malware_calc_idf), 4)
    _4_binary_malware_tf_idf2 = np.round(np.multiply(np.multiply(_4malware_tf, _4malware_df),_4_binary_malware_calc_idf), 4)
    _4_binary_malware_tf_idf3 = np.round(np.multiply(np.multiply(_4malware_tf, np.log2(_4malware_df+0.1)),_4_binary_malware_calc_idf), 4)
    _4_binary_malware_tf_idf4 = np.round(np.multiply(np.multiply(_4malware_tf, np.log10(_4malware_df+0.1)),_4_binary_malware_calc_idf), 4)
    ...
    # 2gram-benign
    data = np.stack((_2benign_tf, _2malware_tf,_2benign_calc_tf, _2malware_calc_tf, _2benign_df, _2malware_df, _2_binary_benign_tf_idf, _2_binary_malware_tf_idf1,_2_binary_malware_tf_idf2,_2_binary_malware_tf_idf3,_2_binary_malware_tf_idf4), axis=1)
    data_df = pd.DataFrame(data, columns=["2gram_benign_TF", "2gram_malware_TF","2gram_benign_calc_TF", "2gram_malware_calc_TF", "2gram_benign_DF",
                                          "2gram_malware_DF", "2gram_binary_benign_TF-IDF","2gram_binary_malware_TF-IDF1", "2gram_binary_malware_TF-IDF2", "2gram_binary_malware_TF-IDF3", "2gram_binary_malware_TF-IDF4"],
    ...
    rows1 = zip(key2List, _2benign_tf.tolist(), _2malware_tf.tolist(),_2benign_calc_tf.tolist(), _2malware_calc_tf.tolist(), _2benign_df.tolist(),
                _2malware_df.tolist(), _2_binary_benign_tf_idf.tolist(), _2_binary_malware_tf_idf1.tolist(),_2_binary_malware_tf_idf2.tolist(),_2_binary_malware_tf_idf3.tolist(),_2_binary_malware_tf_idf4.tolist())
    with open('2gram_api_result.csv', 'w', encoding='utf-8') as f:
        ...
        w1.writerow(["2gram_api", "2gram_benign_TF", "2gram_malware_TF", "2gram_benign_calc_TF", "2gram_malware_calc_TF", "2gram_benign_DF", "2gram_malware_DF",
                     "2gram_binary_benign_TF-IDF", "2gram_binary_malware_TF-IDF1", "2gram_binary_malware_TF-IDF2", "2gram_binary_malware_TF-IDF3", "2gram_binary_malware_TF-IDF4"])
        for row in rows1:
            w1.writerow(row)

    # 3gram-benign
    data = np.stack((_3benign_tf, _3malware_tf,_3benign_calc_tf, _3malware_calc_tf, _3benign_df, _3malware_df, _3_binary_benign_tf_idf, _3_binary_malware_tf_idf1,_3_binary_malware_tf_idf2,_3_binary_malware_tf_idf3,_3_binary_malware_tf_idf4), axis=1)
    data_df = pd.DataFrame(data, columns=["3gram_benign_TF", "3gram_malware_TF","3gram_benign_calc_TF", "3gram_malware_calc_TF", "3gram_benign_DF",
                                          "3gram_malware_DF", "3gram_binary_benign_TF-IDF","3gram_binary_malware_TF-IDF1", "3gram_binary_malware_TF-IDF2", "3gram_binary_malware_TF-IDF3", "3gram_binary_malware_TF-IDF4"],
    ...
    rows1 = zip(key3List, _3benign_tf.tolist(), _3malware_tf.tolist(),_3benign_calc_tf.tolist(), _3malware_calc_tf.tolist(), _3benign_df.tolist(),
                _3malware_df.tolist(), _3_binary_benign_tf_idf.tolist(), _3_binary_malware_tf_idf1.tolist(),_3_binary_malware_tf_idf2.tolist(),_3_binary_malware_tf_idf3.tolist(),_3_binary_malware_tf_idf4.tolist())
    with open('3gram_api_result.csv', 'w', encoding='utf-8') as f:
        ...
        w1.writerow(["3gram_api", "3gram_benign_TF", "3gram_malware_TF", "3gram_benign_calc_TF", "3gram_malware_calc_TF", "3gram_benign_DF", "3gram_malware_DF",
                     "3gram_binary_benign_TF-IDF", "3gram_binary_malware_TF-IDF1", "3gram_binary_malware_TF-IDF2", "3gram_binary_malware_TF-IDF3", "3gram_binary_malware_TF-IDF4"])
        for row in rows1:
            w1.writerow(row)

    # 4gram-benign
    data = np.stack((_4benign_tf, _4malware_tf,_4benign_calc_tf, _4malware_calc_tf, _4benign_df, _4malware_df, _4_binary_benign_tf_idf, _4_binary_malware_tf_idf1,_4_binary_malware_tf_idf2,_4_binary_malware_tf_idf3,_4_binary_malware_tf_idf4), axis=1)
    data_df = pd.DataFrame(data, columns=["4gram_benign_TF", "4gram_malware_TF","4gram_benign_calc_TF", "4gram_malware_calc_TF", "4gram_benign_DF",
                                          "4gram_malware_DF", "4gram_binary_benign_TF-IDF","4gram_binary_malware_TF-IDF1", "4gram_binary_malware_TF-IDF2", "4gram_binary_malware_TF-IDF3", "4gram_binary_malware_TF-IDF4"],
    ...
    rows1 = zip(key4List, _4benign_tf.tolist(), _4malware_tf.tolist(),_4benign_calc_tf.tolist(), _4malware_calc_tf.tolist(), _4benign_df.tolist(),
                _4malware_df.tolist(), _4_binary_benign_tf_idf.tolist(), _4_binary_malware_tf_idf1.tolist(),_4_binary_malware_tf_idf2.tolist(),_4_binary_malware_tf_idf3.tolist(),_4_binary_malware_tf_idf4.tolist())
    with open('4gram_api_result.csv', 'w', encoding='utf-8') as f:
        ...
        w1.writerow(["4gram_api", "4gram_benign_TF", "4gram_malware_TF", "4gram_benign_calc_TF", "4gram_malware_calc_TF", "4gram_benign_DF", "4gram_malware_DF",
                     "4gram_binary_benign_TF-IDF", "4gram_binary_malware_TF-IDF1", "4gram_binary_malware_TF-IDF2", "4gram_binary_malware_TF-IDF3", "4gram_binary_malware_TF-IDF4"])
        for row in rows1:
            w1.writerow(row)
